                ...
                <div class="prestito-card <?= $status_class ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-details-bottom">
                            ...
                            <a href="../catalog/dettaglio_libro.php?id=<?= $prest['id_libro'] ?>" class="btn-primary">Vedi Dettagli Libro</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-details-bottom">
                            ...
                            <div style="display: flex; gap: 10px;">
                                <a href="../catalog/dettaglio_libro.php?id=<?= $pren['id_libro'] ?>" class="btn-primary">Vedi Dettagli Libro</a>
