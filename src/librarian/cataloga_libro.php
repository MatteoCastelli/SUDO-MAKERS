...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/catalogaLibroStyle.css">
</head>
<body>
...
<div class="dashboard-container">
    ...
    <?php if(isset($_GET['success'])): ?>
        <div class="alert alert-success">
            ✓ Libro catalogato con successo! <a href="../catalog/dettaglio_libro.php?id=<?= $_GET['id_libro'] ?>">Visualizza libro</a>
        </div>
    <?php endif; ?>
