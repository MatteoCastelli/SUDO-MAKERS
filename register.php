...
//$municipalities = $finder->findMunicipalitiesByName('Thiene', true);
...
if(!empty($_POST)) {
    ...
    $utente = $stmt->fetch();
    if($utente){
        $errors["email"] = "Utente già registrato con questa mail";
    }
...
<form method="POST" action="register.php">
    ...
    <div class="form-row">
        ...
        <input type="text" id="comune_nascita" name="comune_nascita" required>
    </div>
